    ...
    payload.update(
        {
            ...
            "gnn_decision_status": gnn_risk.get("gnn_decision_status", "unavailable"),
            "gnn_score_kind": gnn_risk.get("gnn_score_kind", "heuristic"),
            "gnn_artifact_id": gnn_risk.get("gnn_artifact_id", ""),
            "gnn_data_quality_status": gnn_risk.get("gnn_data_quality_status", "unknown"),
            "gnn_dataset_version": gnn_risk.get("gnn_dataset_version", ""),
            "gnn_dataset_hash": gnn_risk.get("gnn_dataset_hash", ""),
            "gnn_trained_at": gnn_risk.get("gnn_trained_at", ""),
