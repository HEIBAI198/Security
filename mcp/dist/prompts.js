...
function workspaceHint(workspaceId) {
    return workspaceId
...
export function registerPrompts(server) {
    server.registerPrompt('supplyguard.explain_for_judges', {
        title: '面向评委解释溯源结论',
    ...
    server.registerPrompt('supplyguard.triage_risk', {
        title: '风险处置优先级分析',
    ...
    server.registerPrompt('supplyguard.summarize_attack_chain', {
        title: '攻击链人话总结',
    ...
    server.registerPrompt('supplyguard.prepare_defense_script', {
        title: '生成答辩讲稿',
    ...
    server.registerPrompt('supplyguard.suggest_next_evidence', {
        title: '建议下一步补证据',
